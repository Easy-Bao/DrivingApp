...
func (_c *RefreshSessionCreate) SetUserID(v int) *RefreshSessionCreate {
...
func (_c *RefreshSessionCreate) createSpec() (*RefreshSession, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(refreshsession.Table, sqlgraph.NewFieldSpec(refreshsession.FieldID, field.TypeInt))
	)
