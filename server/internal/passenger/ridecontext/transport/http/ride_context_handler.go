...
func coordinatesFromQuery(request *http.Request) (*ridecontextdomain.Coordinates, error) {
...
func toResponse(snapshot ridecontextdomain.RideContextSnapshot) snapshotResponse {
