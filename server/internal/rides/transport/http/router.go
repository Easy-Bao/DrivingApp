...
func (router *Router) RegisterRoutes(mux chi.Router) {
	...
	mux.Get(apiPrefix+"/bids/{sessionID}", router.handler.Session)
	mux.Get(apiPrefix+"/bids/{sessionID}/offers", router.handler.Offers)
	mux.Post(apiPrefix+"/bids/{sessionID}/offer", router.handler.PlaceOffer)
	mux.Post(apiPrefix+"/bids/{sessionID}/offers/{offerID}/accept", router.handler.AcceptOffer)
	mux.Post(apiPrefix+"/bids/{sessionID}/cancel", router.handler.CancelSession)
	mux.Post(apiPrefix+"/bids/{sessionID}/cancel-offer", router.handler.CancelOffer)
