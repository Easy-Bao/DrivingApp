...
import 'package:driver_app/src/Core/Constants/ApiEndpoints.dart';
import 'package:driver_app/src/Features/Chat/Presentation/Bloc/ChatCubit.dart';
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemCount:
                        chatHistoryMessages.length + (_passengerTyping ? 1 : 0),
                    itemBuilder: (ctx, i) {
                      if (i == chatHistoryMessages.length && _passengerTyping) {
                        return _buildTyping();
                      }
