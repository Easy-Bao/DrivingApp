 ...
 * initiates an asynchronous request to the Mapbox routing API. If a valid route is calculated
 * by the routing service, the coordinates list is returned. If the lookup fails, times out,
 * or encounters a network issue, the repository intercepts the exception, logs it, and
 * generates a straight-line interpolation of the coordinates as a fallback to ensure the
 * map route layer displays successfully.
 *
 * **State & Concurrency:**
 * Route optimization executes asynchronously on Mapbox's routing API.
 */
