              ...
              child: Material(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: widget.isError ? const Color(0xFFFFECEC) : const Color(0xFFE8F6F0),
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(
                        widget.isError ? LucideIcons.circle_alert : LucideIcons.circle_check_big,
                        color: widget.isError ? AppTheme.cancel : AppTheme.complete,
                        size: 20,
                      ),
