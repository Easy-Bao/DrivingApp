          ...
          child: ListView(
            ...
            children: [
              ...
              const _TermsSection(
                title: 'Using BaoRide',
                body:
                    'Use accurate account and trip information, follow applicable laws, and treat drivers and other riders respectfully.',
              ),
              const _TermsSection(
                title: 'Ride requests and payments',
                body:
                    'Review pickup, destination, fare, and payment details before confirming. Charges and adjustments shown in the app apply to the completed ride.',
              ),
              const _TermsSection(
