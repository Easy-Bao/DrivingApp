    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          // Growing Container bounds (Originates from search bar pill and grows full screen)
          ...
          return Stack(
            children: [
              ...
              // 2. M3 Growing Surface Container (Originates from Search Bar Pill and expands to full screen)
              if (t > 0)
                Positioned(
                  left: containerLeft,
                  top: containerTop,
