...
class _DriverMatchedScreenState extends State<DriverMatchedScreen>
  ...
  /**
   * Initializes visual feedback and schedules automatic navigation.
   * If the ride was already generated by the matching state machine, 
   * it skips the database creation pipeline.
   */
