...
abstract class RustLibApi extends BaseApi {
  ...
  Future<FareResult> crateApiFareApiComputeFareDefault(
      {required double distanceKm, required double durationMinutes});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  void sse_encode_box_autoadd_fare_config(
      FareConfig self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_box_autoadd_rust_place_result(
      RustPlaceResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_box_autoadd_rust_route_result(
      RustRouteResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_coord_pair(
      List<CoordPair> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  void sse_encode_list_heatmap_cell(
      List<HeatmapCell> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  void sse_encode_list_nearby_driver(
      List<NearbyDriver> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  void sse_encode_list_rust_place_result(
      List<RustPlaceResult> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  void sse_encode_route_sequence_result(
      RouteSequenceResult self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
