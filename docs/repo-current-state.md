...
use-case and Ent adapter boundaries. Location remains a Mapbox module; realtime
geo is Redis-backed and chat is a realtime hub. Full legacy parity for OTP mail
