...
class const AppPageFrame({
  super.key,
  required this.child,
  this.padding,
  this.maxWidth = AppDesignTokens.pageMaxWidth,
}) extends StatelessWidget {
  final Widget child;
  final EdgeInsetsGeometry? padding;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final horizontalPadding =
            constraints.maxWidth >= AppDesignTokens.wideLayoutBreakpoint
